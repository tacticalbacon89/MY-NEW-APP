...
if(WIN32)
    ...
    if(WX_stc AND "dynamic" STREQUAL "static")
...
if("dynamic" STREQUAL "static" AND NOT "wx::core" IN_LIST wxWidgets_LIBRARIES)
...
if(WIN32 AND "dynamic" STREQUAL "static" AND NOT "wx::core" IN_LIST wxWidgets_LIBRARIES)
